/**************************************************************************
  DIY Phone v31 - Pixel-based Scrolling Interface
  ...
  v31 Changes (Pixel-based Scrolling):
  - Implemented pixel-based scrolling for smooth partial message visibility
  - Replaced message-based scrolling with document-style scrolling
  - Messages can now be viewed partially when scrolling through conversation
  - Added smart scroll bounds checking based on total content height
...
void setup(void) {
  ...
  updateStatusMessage("Ready - v31 Interface", ST77XX_GREEN);
  Serial.println("===============================================");
...
void drawConversationPane() {
  ...
  int screenStartY = CONVERSATION_Y + 15;
  int screenEndY = CONVERSATION_Y + CONVERSATION_HEIGHT;
  
  Serial.print("[VIEWPORT] screenStartY=");
  Serial.print(screenStartY);
  Serial.print(" screenEndY=");
  Serial.print(screenEndY);
  Serial.print(" (");
  Serial.print(screenEndY - screenStartY);
  Serial.println(" pixels tall)");
  ...
  for (int msgIndex = 0; msgIndex < currentThreadMessageCount; msgIndex++) {
    ...
    if (screenY < screenEndY && screenY + messageHeight > screenStartY) {
      Serial.print("[DRAW] Msg ");
      Serial.print(msgIndex);
      Serial.print(" at screenY=");
      Serial.print(screenY);
      Serial.print(" height=");
      Serial.print(messageHeight);
      Serial.print(" content='");
      Serial.print(msg.content.substring(0, 20));
      Serial.println("...'");
      if (msg.isOutgoing) {
  ...
  Serial.print("[DRAW COMPLETE] Final virtualY: ");
