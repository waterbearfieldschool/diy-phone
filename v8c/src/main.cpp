/**************************************************************************
  Adapted from Adafruit ST7735 Library graphics test example
  Modified to use custom SPI bus with nRF52840
 **************************************************************************/
...
void testtriangles();
void mediabuttons();
void updateStatus(char *text, uint16_t color);
...
void setup(void) {
  ...
  tft.setRotation(3); // 0: portrait; 1: landscape; 2 portrait upside down, and 3 landscape upside down
...
updateStatus("Starting up...",ST77XX_WHITE);
delay(500);
...
void loop() {
  ...
  //updateStatus(cstr,ST77XX_WHITE);
  updateStatus("Starting up...",ST77XX_WHITE);
  delay(500);
  i=i+1;
