...
def display_inbox():
    ...
    info_area.text = "↑↓:select  ENTER/→:thread  C:compose  N:refresh  D:del SIM  ESC:quit"
...
def display_thread_view():
    ...
    # Sort by timestamp (filename contains timestamp) - most recent first
    thread_messages.sort(key=lambda x: x['filename'], reverse=True)
