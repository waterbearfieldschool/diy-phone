...
featured. A reserved small-font line at the top reads `(latest message)`,
`(1 newer message)`, or `(N newer messages)` to say where the selection
sits. The name is bold (FreeMonoBold shares FreeMono's cell
