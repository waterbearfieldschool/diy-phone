...
void setup(void) {
  ...
  // Use this initializer if using a 1.47" 172x320 TFT:
  //tft.init(172, 320);   // Init ST7789 172x320

  // Use this initializer if using a 1.69" 280x240 TFT:
  //tft.init(240, 280);   // Init ST7789 280x240

  // Use this initializer if using a 1.9" or 2.0" 320x170 TFT:
  //tft.init(170, 320);   // Init ST7789 320x170

  // Use this initializer if using a 1.14" 135x240 TFT:
