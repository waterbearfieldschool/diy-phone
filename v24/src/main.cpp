...
void setup(void) {
  ...
  tft.drawRGBBitmap(0, inboxY, inbox_canvas.getBuffer(), inbox_canvas.width(), currentInboxHeight);
  tft.drawRGBBitmap(0, currentMessageY, message_canvas.getBuffer(), message_canvas.width(), currentMessageHeight);
