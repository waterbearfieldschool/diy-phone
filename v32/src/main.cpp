/**************************************************************************
  DIY Phone v32 - Optimized Composition Interface
  ...
  v32 Changes (Optimized Composition):
  - Eliminated thread panel flashing during message composition
  - Added drawComposeAreaOnly() for efficient typing updates
  - Smart redraw logic: compose-only vs full redraw based on message length
  - Prevents unnecessary conversation redraws during typing
