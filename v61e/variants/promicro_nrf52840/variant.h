...
// I2C pins based on promicromap.txt: SDA=P1.04(pin8), SCL=P0.11(pin7)
...
#define SS                   PIN_SPI_NSS

// Standard Arduino aliases; libraries (e.g. GxEPD2) expect these to exist.
