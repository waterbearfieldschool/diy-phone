/**************************************************************************
  DIY Phone v20 - SMS Inbox with Address Book + I2C Debug
  Features: Display + SIM7600 + SD card SMS storage + I2C keyboard control + Address book name lookup + Full timestamps + Proper chronological sorting
  ...
  v20 Changes: Enhanced I2C debugging to diagnose keyboard warning
 **************************************************************************/
