...
boot checklist) stays at the small 6px font. The inbox shows four
conversations per screen, each a flowing `name|time|preview` that wraps
onto its second line. The name is bold (FreeMonoBold shares FreeMono's cell
