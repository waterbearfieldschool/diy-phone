/**************************************************************************
  DIY Phone v14 - SIM7600 with SD Card SMS Storage
  Features: Display + SIM7600 + SD card SMS storage
 **************************************************************************/
...
void setup(void) {
  ...
  Serial.println("=== DIY Phone v14 Starting ===");
  ...
  if (sd.begin(SD_CS_PIN, SD_SCK_MHZ(4))) {
    ...
    if (testFile) {
      testFile.println("DIY Phone v14 Test");
      testFile.close();
